namespace Nacos.V2
{
    ...
    public interface INacosNamingService
    {
        ...
        /// <summary>
        /// Update an existing instance in a service.
        /// </summary>
        /// <param name="serviceName">name of service</param>
        /// <param name="groupName">group of service</param>
        /// <param name="instance">instance with updated properties</param>
        ...
        // TODO(N-3x-2): BatchDeregisterInstance — bulk service deregistration via BatchDeregisterServiceRequest.
        //   Requires server-side ability check: AbilityKeys.SupportDeregisterOnDisconn.
        //   Java ref: NamingGrpcClientProxy.batchDeregisterService()

        // TODO(N-3x-3): NacosLockService — tryLock / releaseLock via LockRequest/LockResponse (gRPC).
        //   Nacos 3.0 experimental distributed lock API. No Java SDK stable yet.

        // TODO(N-AI): INacosAiService — MCP Server / AgentCard / Prompt management.
        //   Nacos 3.1 feature. Java SDK already implemented. Python SDK v3.0.0 implemented.
        //   Depends on N-M10 (ability check) and N-M14 (AbilityKeys).
    }
}
