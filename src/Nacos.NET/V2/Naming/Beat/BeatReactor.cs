namespace Nacos.V2.Naming.Beat
{
    ...
    public class BeatReactor
    {
        ...
        private readonly long _defaultBeatInterval;
        ...
        public BeatReactor(ILogger logger, NamingHttpClientProxy serverProxy, NacosSdkOptions options)
        {
            ...
            this._defaultBeatInterval = options?.HeartBeatInterval > 0 ? options.HeartBeatInterval : 5000L;
        ...
        internal BeatInfo BuildBeatInfo(string groupedServiceName, Instance instance)
        {
            return new BeatInfo
            {
                ...
                Period = instance.GetInstanceHeartBeatInterval() == Constants.DEFAULT_HEART_BEAT_INTERVAL
                    ? _defaultBeatInterval
