namespace Nacos.V2.Remote
{
    ...
    public static class RemoteRequestType
    {
        ...
        public static readonly string Req_Naming_FuzzyWatch = "NamingFuzzyWatchRequest";

        public static readonly string Resp_Naming_FuzzyWatch = "NamingFuzzyWatchResponse";

        public static readonly string Req_Naming_FuzzyWatchNotify = "NamingFuzzyWatchNotifyRequest";

        public static readonly string Resp_Naming_FuzzyWatchNotify = "NamingFuzzyWatchNotifyResponse";

        public static readonly string Req_Config_FuzzyWatch = "ConfigFuzzyWatchRequest";

        public static readonly string Resp_Config_FuzzyWatch = "ConfigFuzzyWatchResponse";

        public static readonly string Req_Config_FuzzyWatchNotify = "ConfigFuzzyWatchNotifyRequest";

        public static readonly string Resp_Config_FuzzyWatchNotify = "ConfigFuzzyWatchNotifyResponse";
        ...
        public static Dictionary<string, Type> RemoteResponseTypeMapping = new Dictionary<string, Type>
        {
            ...
            { Resp_Naming_FuzzyWatch, typeof(NamingFuzzyWatchResponse) },
            { Req_Naming_FuzzyWatchNotify, typeof(NamingFuzzyWatchNotifyRequest) },
            { Resp_Naming_FuzzyWatchNotify, typeof(NamingFuzzyWatchNotifyResponse) },
            { Resp_Config_FuzzyWatch, typeof(ConfigFuzzyWatchResponse) },
            { Req_Config_FuzzyWatchNotify, typeof(ConfigFuzzyWatchNotifyRequest) },
            { Resp_Config_FuzzyWatchNotify, typeof(ConfigFuzzyWatchNotifyResponse) },
        };
    }
}
